//Selecionar elementos individuais

//document.getElementById('PEga o id')

//document.querySelector('PEga o seletor CSS #id,.Class ou Tag') consigo passar um seletor inteiro css 'li.primeiro'
...
function troque(){
    ...
    let trocar = document.querySelector('.primeiro')
    trocar.innerHTML = 'Troquei o Item 1'
}
