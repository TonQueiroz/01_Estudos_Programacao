...
condção = input('Você já se alistou? S/N')
...
if condção == "N":
    ...
    if idade == 17:
        print('você completara ou completou {} anos esse ano! está na hora de se alistar!'.format(idade))

    elif idade < 17 :
        print('Ainda não chegou a hora do alistamento faltam {} anos'.format(17 - idade))
        print('Seu alistamento será em {}'.format (anodenascimento + 17))

    elif idade > 17:
        print('já passou ', idade - 17, ' anos do tempo do seu alistamento, vá se alistar cuzão! ')
        print('Seu alistamento deveria ter sido em {}'.format (anodenascimento + 17))

else:
    print('Obrigado por sservir o seu país!')
